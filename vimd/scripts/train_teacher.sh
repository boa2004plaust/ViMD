...
CUDA_VISIBLE_DEVICES=1 torchrun --master_port=8080 --nproc_per_node=1 train_teacher.py  \
...
--output_dir /home/hello/code/SR_MAMBA/script/DOG/vimtiny_DOG_HRresize224 \
