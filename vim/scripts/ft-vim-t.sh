...
CUDA_VISIBLE_DEVICES=1 torchrun --master_port=8089 --nproc_per_node=1 mainfd.py  \
...
--output_dir /home/hello/code/SR_MAMBA/script/DOG/vimtiny_SRGAN_DOG_HiddenStates24Msenonorm5.0_KD0.0  \
